...
exports.returnBook = exports.borrowBook = exports.getBorrowedBooks = exports.prisma = void 0;
...
exports.getBorrowedBooks = (0, createController_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const borrowedBooks = yield exports.prisma.borrowedBook.findMany();
...
exports.returnBook = (0, createController_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { borrowedBookId } = req.params;
        yield exports.prisma.borrowedBook.delete({
